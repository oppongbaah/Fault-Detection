function [Output] = my_ANFIS()
    ...
    switch ANSWER
        ...
        case Option{2}
            ...
            fis = genfis(TrainInput, TrainTarget, fisOptions);   
        case Option{3}
            % FIS type can be sugeno or mamdani
            ...
            PARAMS=inputdlg(Prompt,Title,1,DefaultValues);
            pause(0.01);
            % We can optimize these parameters with PSO
    ...
    % 0: Backpropagation
    % 1: Hybrid - uses Backpropagation for input mem ftns and least square estimation for the output mem ftns  
